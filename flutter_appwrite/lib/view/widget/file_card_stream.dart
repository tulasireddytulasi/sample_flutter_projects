...
class FileCardStream extends StatefulWidget {
  const FileCardStream({super.key, required this.filePath, required this.width});

  final String filePath;
  final double width;

  @override
  State<FileCardStream> createState() => _FileCardStreamState();
}

class _FileCardStreamState extends State<FileCardStream> {
  String filePath = "";
